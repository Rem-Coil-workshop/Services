...
set CLASSPATH=%APP_HOME%\lib\slot_sistem_main_server-0.0.1.jar;%APP_HOME%\lib\kodein-di-framework-ktor-server-jvm-7.5.0.jar;%APP_HOME%\lib\ktor-serialization-jvm-1.6.1.jar;%APP_HOME%\lib\ktor-server-netty-jvm-1.6.1.jar;%APP_HOME%\lib\ktor-server-host-common-jvm-1.6.1.jar;%APP_HOME%\lib\ktor-server-core-jvm-1.6.1.jar;%APP_HOME%\lib\config4k-0.4.2.jar;%APP_HOME%\lib\exposed-java-time-0.31.1.jar;%APP_HOME%\lib\kodein-di-jvm-7.5.0.jar;%APP_HOME%\lib\exposed-dao-0.31.1.jar;%APP_HOME%\lib\exposed-jdbc-0.31.1.jar;%APP_HOME%\lib\exposed-core-0.31.1.jar;%APP_HOME%\lib\kotlinx-coroutines-jdk8-1.5.0-native-mt.jar;%APP_HOME%\lib\ktor-http-cio-jvm-1.6.1.jar;%APP_HOME%\lib\ktor-http-jvm-1.6.1.jar;%APP_HOME%\lib\ktor-network-jvm-1.6.1.jar;%APP_HOME%\lib\ktor-utils-jvm-1.6.1.jar;%APP_HOME%\lib\ktor-io-jvm-1.6.1.jar;%APP_HOME%\lib\kotlinx-coroutines-core-jvm-1.5.0-native-mt.jar;%APP_HOME%\lib\kodein-type-jvm-1.6.0.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.5.20.jar;%APP_HOME%\lib\h2-1.4.200.jar;%APP_HOME%\lib\flyway-core-7.10.0.jar;%APP_HOME%\lib\logback-classic-1.2.3.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.5.20.jar;%APP_HOME%\lib\kotlin-reflect-1.5.10.jar;%APP_HOME%\lib\ktor-jvm-1.4.2.jar;%APP_HOME%\lib\kotlinx-serialization-json-jvm-1.2.1.jar;%APP_HOME%\lib\kotlinx-serialization-core-jvm-1.2.1.jar;%APP_HOME%\lib\kotlin-stdlib-1.5.20.jar;%APP_HOME%\lib\slf4j-api-1.7.30.jar;%APP_HOME%\lib\config-1.3.3.jar;%APP_HOME%\lib\netty-codec-http2-4.1.63.Final.jar;%APP_HOME%\lib\alpn-api-1.1.3.v20160715.jar;%APP_HOME%\lib\netty-transport-native-kqueue-4.1.63.Final.jar;%APP_HOME%\lib\netty-transport-native-epoll-4.1.63.Final.jar;%APP_HOME%\lib\logback-core-1.2.3.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.5.20.jar;%APP_HOME%\lib\netty-codec-http-4.1.63.Final.jar;%APP_HOME%\lib\netty-handler-4.1.63.Final.jar;%APP_HOME%\lib\netty-codec-4.1.63.Final.jar;%APP_HOME%\lib\netty-transport-native-unix-common-4.1.63.Final.jar;%APP_HOME%\lib\netty-transport-4.1.63.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.63.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.63.Final.jar;%APP_HOME%\lib\netty-common-4.1.63.Final.jar
